...
@section('content')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('form-survey.submit2') }}">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page = 1) {
                ...
                var baseUrl = "{!! url('/report-kalibrasi-user/search') !!}?query=" + query;
                $.ajax({
                    url: baseUrl,
                    type: 'GET',
                    data: {
    ...
    <script>
        ...
        $('#surveyModal').on('show.bs.modal', function(event) {
            ...
            $('#kalibrasi_id').val(pengajuanId); // Set the value of the hidden input field
        });
    </script>
    <script>
