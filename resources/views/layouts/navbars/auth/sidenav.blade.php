<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'report-user' ? 'active' : '' }}" href="{{ route('report-user') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'report-kalibrasi-user' ? 'active' : '' }}" href="{{ route('report-kalibrasi-user') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-single-02 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'form' ? 'active' : '' }}" href="{{ route('form') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-single-02 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'formkalibrasi' ? 'active' : '' }}" href="{{ route('formkalibrasi') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-single-02 text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'history-pengajuan' ? 'active' : '' }}" href="{{ route('history-pengajuan') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-single-02 text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Riwayat Pengujian</span>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'history-kalibrasi' ? 'active' : '' }}" href="{{ route('history-kalibrasi') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-single-02 text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Riwayat Kalibrasi</span>
